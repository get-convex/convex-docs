...
import ActionCircularError from "!!raw-loader!@site/../private-demos/snippets/convex/actionCircularError.ts";
...
[TypeScript](/docs/typescript.mdx#type-annotating-server-side-helpers) page for
other types which might be helpful when annotating the result.
