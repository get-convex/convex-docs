...
Argument validators ensure that [queries](./query-functions.mdx),
[mutations](./mutation-functions.mdx), and [actions](./actions.mdx) are called
...
surprising results. [TypeScript](/typescript) alone won't help because
...
include [TypeScript](/docs/typescript.mdx) type annotations! The type of your
