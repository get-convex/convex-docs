...
If you are using [argument validation](/docs/functions/args-validation.mdx),
Convex will infer the types of your functions arguments automatically:
...
[argument validation](/docs/functions/args-validation.mdx) and
