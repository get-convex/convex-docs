...
import AppJS from "!!raw-loader!@site/../js_demos/file-storage/src/App.jsx";
...
import HttpAppJS from "!!raw-loader!@site/../js_demos/file-storage-with-http/src/App.jsx";
...
[`QueryCtx`](/api/interfaces/server.QueryCtx) or
[`MutationCtx`](/api/interfaces/server.MutationCtx) object:
...
[`ActionCtx`](/api/interfaces/server.ActionCtx) object, which can be returned in
a `Response`:
