...
search queries look _within_ a string field to find the keywords. This can be
used to build search features within your app like searching for messages that
