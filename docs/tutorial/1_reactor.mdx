...
<Details summary="🤔 Is this a relational or NoSQL database?">
...
<Details summary="🤔 What about JavaScript?">
...
[directly in the dashboard](/docs/dashboard/deployments/data.md#writing-custom-queries)!
