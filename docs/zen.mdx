...
<ZenTip type="do" title={<span>Double down on the <a href="/tutorial/reactor">reactor</a></span>} >
...
<Details summary="Keep reactor functions light & fast">
...
<Details summary="Be thoughtful about the return values of mutations">
  ...
  queries and the reactor do that.
</Details>
